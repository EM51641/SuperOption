...
class Screener_US:
    ...
    def American_Screening(self, _list_, cust, start_date, end_date, Answer):

        i_r = wb.DataReader('^IRX',data_source='yahoo',start='2022-05-10')['Adj Close'].iloc[0,-1]
        S_name=[]
        C_value=[]
        P_value=[]
        S_Price=[]
    ...
    def __init__(self, _list_, cust, start_date, end_date, Answer):
        self.liste=_list_
        self.cust = cust
        self.start_date = start_date
        self.end_date = end_date
        self.Answer = Answer
        self.AMScreen=self.American_Screening(_list_, cust, start_date, end_date, Answer)
